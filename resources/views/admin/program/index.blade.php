                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-1">
                                ...
                                <form action="/admin/program/{{ $item->id }}" method="post" class="delete-form m-0">
                                    @method('DELETE')
                                    @csrf
                        ...
                        <div class="modal-dialog bg-white">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="/admin/program/{{ $item->id }}" method="post"
                        ...
                        button.addEventListener('click', function(event) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    this.parentNode.action = '/admin/program/' + id;
...
<div class="modal fade" id="addNew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: white">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="mdi mdi-library-plus"></i> Tambah Program
                    Baru
                </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/admin/saveProgram" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="judul" class="mb-1">Judul</label>
                        <input type="text" class="form-control" id="judul" name="judul"
                            placeholder="input judul Program">
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="mb-1">Deskripsi</label>
                        <textarea name="deskripsi" id="deskripsi" cols="30" rows="3" class="form-control"
                            placeholder="input deskripsi Program"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="foto" class="mb-1">Foto</label>
                        <input type="file" class="form-control" id="foto" name="foto" required
                            placeholder="input foto Program">
                    </div>
                    <div class="modal-footer">
