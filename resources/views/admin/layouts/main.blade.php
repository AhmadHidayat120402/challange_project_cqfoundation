        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="brand-logo navbar-brand" href="">
                    {{-- <h2 class="fw-bold" style="color: black; font-weight: bold; font-family: Pacifico"></h2> --}}

                    <img src="{{ URL::asset('assets/images/logo_length.png') }}" alt="logo"
                        style="object-fit: contain" />
                </a>
                <a class="navbar-brand brand-logo-mini" href="index.html">
                    <img src="{{ asset('assets/images/Logo.png') }}" alt="" width="100px" class="py-2" />
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#"
                            ...
                            <div class="nav-profile-img">
                                <img src="{{ URL::asset('assets/images/logo.png') }}" alt="image">
